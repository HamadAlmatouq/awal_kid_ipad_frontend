    ...
    _timer = Timer.periodic(Duration(seconds: 1), (timer) {
      setState(() {
        for (var task in tasks) {
          if (task.timeLeft != null && task.timeLeft! > 0) {
            task.timeLeft = task.timeLeft! - (1 / 3600); // Decrease by 1 second
          }
        }
      });
    });
      ...
      builder: (BuildContext context) {
        return CustomTaskDialog(
          ...
          timeLeft: task.timeLeft != null
              ...
              : 'No time left',
          progress: task.duration != null && task.timeLeft != null
              ? 1 - (task.timeLeft! / task.duration!)
              : 0,
          onDone: () {
